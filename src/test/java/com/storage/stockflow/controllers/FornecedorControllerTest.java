...
import com.storage.stockflow.controllers.messages.FornecedorMessage;
import com.storage.stockflow.domain.dtos.FornecedorDTO;
...
public class FornecedorControllerTest {
    ...
    public void testDelete() throws Exception {
        ...
        verify(fornecedorService, times(1)).delete(fornecedorExistente.getId());
    }
