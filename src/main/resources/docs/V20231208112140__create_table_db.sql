CREATE TABLE produto_capa (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
   ...
   tipo_produto TINYINT,
   medida_unidade TINYINT,
   fornecedor_id BIGINT,
   minimo BIGINT,
   maximo BIGINT,
   resuprimento TINYINT,
...
CREATE SEQUENCE revisao_seq;

CREATE TABLE revinfo (
    rev INTEGER DEFAULT nextval('hibernate_sequence') NOT NULL,
    revtstmp BIGINT,
    PRIMARY KEY (rev)
);
...
(
    id INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    rev                BIGINT REFERENCES revinfo (rev), -- The version number of the entity.
    revend             BIGINT REFERENCES revinfo (rev), -- The version of the next version number after entity gets updated.
