    ...
    create table fornecedor (
        ...
        tipo_empresa tinyint check (tipo_empresa between 0 and 1),
    ...
    create table produto_capa (
        ativo boolean not null,
        cod_sistema integer,
        medida_unidade tinyint not null check (medida_unidade between 0 and 10),
        resuprimento tinyint check (resuprimento between 0 and 4),
        tipo_produto tinyint not null check (tipo_produto between 0 and 2),
        created_date timestamp(6) with time zone not null,
    ...
    create table produto_saida (
        setor tinyint not null check (setor between 0 and 4),
        created_date timestamp(6) with time zone not null,
